...
export const es = {
  ...
  "cart.save": "Guardar ${item} para más tarde",
  "cart.decrease": "Reducir la cantidad de ${item}",
  "cart.increase": "Aumentar la cantidad de ${item}",
  ...
  "featured-categories.label": "Categorías destacadas",
  "featured-categories.fresh-and-juicy": "Fresco y jugoso",
  "featured-categories.full-and-rich": "Pleno e intenso",
  "featured-categories.light-and-crisp": "Ligero y fresco",
