...
export const ca = {
  ...
  "cart.decrease": "Redueix la quantitat de ${item}",
  "cart.increase": "Augmenta la quantitat de ${item}",
  ...
  "featured-categories.label": "Categories destacades",
  "featured-categories.fresh-and-juicy": "Fresc i sucós",
  "featured-categories.full-and-rich": "Ple i intens",
  "featured-categories.light-and-crisp": "Lleuger i fresc",
