  ...
  return (
    <div id={id} className="relative" {...rest}>
      ...
      <Popover
        ...
        placement="bottom"
        className="right-0 z-50 mt-1 min-w-fit w-full rounded-xl md:min-w-64 md:rounded-lg md:border md:border-input bg-popover text-popover-foreground md:shadow-md p-1"
      >
